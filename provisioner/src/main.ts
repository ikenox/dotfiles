...
void execute(['username', 'email'], ({username, email}, {home}) => [
  ...
  symlink(`${home}/.dotfiles/claude/statusline.sh`, `${home}/.claude/statusline.sh`),
symlink(`${home}/.dotfiles/claude/skills`, `${home}/.claude/skills`),
  ...
  symlink(`${home}/.dotfiles/zed/settings.json`, `${home}/.config/zed/settings.json`),
  symlink(`${home}/.dotfiles/zed/keymap.json`, `${home}/.config/zed/keymap.json`),
  symlink(`${home}/.dotfiles/zed/themes`, `${home}/.config/zed/themes`),
  symlink(`${home}/.dotfiles/helix/config.toml`, `${home}/.config/helix/config.toml`),
  symlink(`${home}/.dotfiles/helix/languages.toml`, `${home}/.config/helix/languages.toml`),
